...
Builds possible provider symbols

Fetches daily OHLCV market data

Cleans and standardizes the dataset

Calculates technical indicators

Builds the latest market snapshot

Detects market regime and trend direction

Produces rule-based technical signals

Prints a recent indicator table
